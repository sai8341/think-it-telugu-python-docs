...
<CardGroup cols={1}>
  <Card title="Looping Through Lists" icon="arrow-right" href="/part-2/module-8-lists/looping-lists">
    Learn standard for-loops, enumerate(), and index-based iteration
  </Card>
</CardGroup>