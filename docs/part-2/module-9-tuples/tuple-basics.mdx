...
<CardGroup cols={1}>
  <Card title="Packing & Unpacking Tuples" icon="arrow-right" href="/part-2/module-9-tuples/packing-unpacking">
    Master tuple packing, unpacking, clean variable swapping, and extended star unpacking
  </Card>
</CardGroup>