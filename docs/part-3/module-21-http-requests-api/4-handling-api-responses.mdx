...
<CardGroup cols={1}>
  <Card title="Module 22: Database Connectivity & SQLite3" icon="arrow-right" href="/part-3/module-22-database-connectivity/intro-to-sqlite3">
    Learn SQL basics, table creation, parameterized queries, and CRUD operations with Python's built-in sqlite3 module
  </Card>
</CardGroup>
