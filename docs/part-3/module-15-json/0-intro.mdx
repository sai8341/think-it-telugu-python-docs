...
* **Core Functions:** `loads()` / `dumps()` for strings, `load()` / `dump()` for disk files.
...
<CardGroup cols={1}>
  <Card title="What is JSON?" icon="arrow-right" href="/part-3/module-15-json/what-is-json">
    Explore the universal data exchange format and how Python handles JSON
  </Card>
</CardGroup>
