...
<CardGroup cols={1}>
  <Card title="Class Methods & Static Methods" icon="arrow-right" href="/part-3/module-13-oop-basics/5-class-static-methods">
    Master shared class variables, @classmethod, and @staticmethod decorators
  </Card>
</CardGroup>
