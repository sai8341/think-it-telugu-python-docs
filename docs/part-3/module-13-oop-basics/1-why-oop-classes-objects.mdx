...
<CardGroup cols={1}>
  <Card title="Memory References & The Dot Operator" icon="arrow-right" href="/part-3/module-13-oop-basics/2-memory-references-dot">
    Understand how Python stores objects in Heap memory and how dot notation works
  </Card>
</CardGroup>
