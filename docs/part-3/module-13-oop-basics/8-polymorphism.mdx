...
<CardGroup cols={1}>
  <Card title="Encapsulation & Data Hiding" icon="arrow-right" href="/part-3/module-13-oop-basics/9-encapsulation">
    Protect private attributes with getters, setters, and @property decorators
  </Card>
</CardGroup>
