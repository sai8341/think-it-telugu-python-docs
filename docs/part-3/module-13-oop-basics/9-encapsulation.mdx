...
<CardGroup cols={1}>
  <Card title="Abstraction & Abstract Base Classes" icon="arrow-right" href="/part-3/module-13-oop-basics/10-abstraction">
    Enforce interface contracts using ABC and @abstractmethod
  </Card>
</CardGroup>
