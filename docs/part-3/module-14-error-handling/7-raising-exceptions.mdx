...
<Quiz
  question="When should you use the 'raise' keyword in Python?"
  options={["To catch errors from other functions", "To manually trigger an error when your program's rules are violated", "To silence all exceptions", "To restart the program"]}
  correctIndex={1}
  explanation="The raise keyword lets you manually trigger exceptions when data violates your application's business rules, even if Python considers the data technically valid."
/>
