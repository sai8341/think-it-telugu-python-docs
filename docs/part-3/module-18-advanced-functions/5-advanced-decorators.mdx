...
<CardGroup cols={1}>
  <Card title="Module 19: Regular Expressions" icon="arrow-right" href="/part-3/module-19-regular-expressions/intro-to-regex">
    Master regex metacharacters, pattern matching, email validation, and text extraction with the re module
  </Card>
</CardGroup>
