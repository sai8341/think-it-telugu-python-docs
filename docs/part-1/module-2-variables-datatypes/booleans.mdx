...
You now know the 3 foundational building blocks of Python: **Strings** (Words), **Numbers** (Math), and **Booleans** (Yes/No). Let's practice using them!

<CardGroup cols={1}>
  <Card title="Lab Exercises & Q&A" icon="arrow-right" href="/part-1/module-2-variables-datatypes/exercises-qa">
    Test your understanding with real practice problems
  </Card>
</CardGroup>
