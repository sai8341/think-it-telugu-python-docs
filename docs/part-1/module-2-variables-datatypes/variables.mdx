---
sidebar_position: 1
title: "Understanding Python Variables for Beginners"
sidebar_label: "Variables"
description: "Learn what Python variables are, how to create them, and the rules for naming variables in your code."
keywords: [python variables, what is a variable, declaring variables in python, python syntax, coding basics]
---
...
* **What is a Variable?** A labeled storage container in memory used to hold data for later use.
* **Assignment Operator (`=`):** Stores the value on the right into the variable named on the left.
* **Dynamic Reassignment:** Variable values can be updated or overwritten as code executes.
* **Naming Rules:** Must start with a letter or underscore, cannot contain spaces, and cannot start with numbers.
* **Standard Style:** Always use `snake_case` (e.g., `user_age`, `total_score`) for multi-word variables.

---

## What's Next?

Now that you know how to store information, let's learn about the different **Built-in Data Types** you can store inside a variable in the next lesson!

<CardGroup cols={1}>
  <Card title="Built-in Data Types" icon="arrow-right" href="/part-1/module-2-variables-datatypes/data-types">
    Learn the difference between fundamental data types (int, float, str, bool) and collection data structures
  </Card>
</CardGroup>
