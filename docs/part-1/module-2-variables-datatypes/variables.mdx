...
<CardGroup cols={1}>
  <Card title="What are Data Types?" icon="arrow-right" href="/part-1/module-2-variables-datatypes/data-types">
    Learn about the different kinds of information we can store
  </Card>
</CardGroup>
