...
Computers need to know exactly what kind of information you are giving them. The "kind" of information you store in a variable is called its **Data Type**.
...
Now that you know how to store information, let's look at the different *types* of information we can store!

<CardGroup cols={1}>
  <Card title="Strings (Text)" icon="arrow-right" href="/part-1/module-2-variables-datatypes/strings">
    Learn how to store and print text
  </Card>
</CardGroup>
