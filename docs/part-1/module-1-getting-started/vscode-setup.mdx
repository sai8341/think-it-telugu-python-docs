---
title: "Setting Up VS Code for Python Development"
sidebar_label: "VS Code Setup"
description: "Learn how to install and configure Visual Studio Code (VS Code) for writing and running Python code."
keywords: [vs code setup, install vscode, vscode for python, python ide, visual studio code python, code editor]
---
...
* **Visual Studio Code:** The industry-standard, lightweight, and free code editor by Microsoft.
* **Python Extension:** Essential plugin in VS Code that enables syntax highlighting, auto-completion (IntelliSense), and built-in run buttons.
* **Workspace Folder:** Always open a dedicated folder (e.g., `Python_Learning`) via `File -> Open Folder` to keep your project organized.

---

## What's Next?

You have Python installed and your smart notebook ready. It's time for the most exciting milestone: writing your very first program in the next lesson!
