  ...
  part3Sidebar: [

    {
      ...
      items: [
        {
          type: 'category',
          label: 'Module 13: Object-Oriented Programming (OOP)',
          className: 'icon-box',
          collapsed: true,
          items: [
        ...
        {
          type: 'category',
          label: 'Module 18: Python for Data Science',
          className: 'icon-data',
          collapsed: true,
          items: [
            'part-3/module-18-python-for-data-science/data-science-intro',
            'part-3/module-18-python-for-data-science/1.5-google-colab',
            'part-3/module-18-python-for-data-science/numpy-basics',
            'part-3/module-18-python-for-data-science/pandas-dataframes',
            'part-3/module-18-python-for-data-science/matplotlib-visualization',
            'part-3/module-18-python-for-data-science/weather-app-project',
            'part-3/module-18-python-for-data-science/exercises-qa',
          ],
        },
        {
          type: 'category',
          ...
          items: [
            ...
            'part-3/module-19-python-for-ai-engineering/rag-embeddings',
            'part-3/module-19-python-for-ai-engineering/pydantic-validation',
            'part-3/module-19-python-for-ai-engineering/exercises-qa',
          ],
        },
      ],
    },
